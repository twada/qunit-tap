...
(function (root, factory) {
    ...
    function qunitTap(qunitObject, printLikeFunction, options) {
        ...
        appendCallback(qu, tap, 'moduleStart');
        appendCallback(qu, tap, 'testStart');
        appendCallback(qu, tap, 'log');
        appendCallback(qu, tap, 'testDone');
        appendCallback(qu, tap, 'done');
