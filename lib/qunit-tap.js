...
var qunitTap = function qunitTap(qunitObject, printLikeFunction, options) {
    ...
    var warnDeprecations = function () {
        if (!options || typeof options !== 'object') {
            return;
        }
        if (typeof options.showDetailsOnFailure !== 'undefined') {
            qu.tap.note('WARNING: Option "showDetailsOnFailure" is deprecated. Please use "showExpectationOnFailure" and "showSourceOnFailure".');
        }
        if (typeof options.count !== 'undefined') {
            qu.tap.note('WARNING: Option "count" is deprecated. Please use "initialCount".');
        }
    };
    ...
    var appendDetailsTo = function (desc, details) {
        ...
        if (qu.tap.showExpectationOnFailure && typeof details.expected !== 'undefined') {
        ...
        if (qu.tap.showSourceOnFailure && typeof details.source === 'string') {
            desc = addSeparatorTo(desc);
            desc += 'source: ';
