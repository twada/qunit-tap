...
var qunitTap = function qunitTap(qunitObject, printLikeFunction, options) {
    ...
    var addListener = function () {
        ...
        var multipleLoggingCallbacksSupported =
        ...
        return function (target, name, listener) {
    ...
    addListener(qu, 'moduleStart', tap.moduleStart);
    addListener(qu, 'testStart', tap.testStart);
    addListener(qu, 'log', tap.log);
    addListener(qu, 'done', tap.done);
