...
var qunitTap = function qunitTap(qunitObject, printLikeFunction, options) {
    ...
    // option deprecation and fallback
    ...
    var appendDetailsTo = function (desc, details) {
        ...
        if (qu.tap.showTestNameOnFailure && typeof details.name === 'string') {
            desc = addSeparatorTo(desc);
            desc += 'test: \'';
            desc += details.name;
            desc += '\'';
        }
        if (qu.tap.showModuleNameOnFailure && typeof details.module === 'string') {
            desc = addSeparatorTo(desc);
            desc += 'module: \'';
            desc += details.module;
            desc += '\'';
