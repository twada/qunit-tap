 ...
 */
var qunit_tap = function (qunit_object, print_like_function, options) {
     if (typeof qunit_object === "undefined") {
         throw new Error("should pass QUnit object reference");
     }
     if (typeof print_like_function !== "function") {
     ...
     qu.tap.puts = print_like_function;  // QUnit.tap.puts can be replaced later (e.g. console.log)
