...
(function (root, factory) {
    ...
    var indexOf = function (ary, element) {
        var i;
    ...
    var removeElement = function (ary, element) {
    ...
    function qunitTap(qunitObject, printLikeFunction, options) {
        ...
        var qu = qunitObject,
            ...
            explain = (jsDumpExists ? function (obj) { return qu.jsDump.parse(obj); } : noop),
            targetEvents = [
                'moduleStart',
                'testStart',
                'log',
        ...
        var unsubscribeEvents = function unsubscribeEvents (eventNames) {
            var eventName, listeners, i;
